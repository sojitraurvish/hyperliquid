...
export const OrderRow = ({ order, isAsk, maxTotal, currency, onClick, isHighlighted = false, compact = false }: OrderRowProps) => {
  ...
  if (compact) {
    return (
      <div
        onClick={onClick}
        className="px-2 py-[3px] flex justify-between text-[9px] font-mono hover:bg-gray-800/20 cursor-pointer relative group transition-colors"
      >
        <div 
